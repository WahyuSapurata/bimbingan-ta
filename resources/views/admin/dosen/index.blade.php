...
@section('script')
    <script>
        ...
        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/delete-dosen/' + $(this).attr('data-uuid');
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        if (full.status == "TERVERIFIKASI") {
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Dosen" class="btn btn-danger button-delete btn-icon btn-sm">
