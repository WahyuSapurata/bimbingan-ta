        ...
        <div class="card w-100">
            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="uuid_bimbingan">
                    ...
                    <div class="mb-10">
                        ...
                        <select name="metode" class="form-select" data-control="select2" id="from_select_metode"
                            data-placeholder="Pilih jenis inputan">
                        </select>
                        <small class="text-danger metode_error"></small>
                    </div>
...
@section('script')
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            e.preventDefault();
            control.submitFormMultipartData('/dosen/add-penjadwalan', 'Tambah',
                'Penjadwalan',
                'POST');
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/dosen/show-penjadwalan/' + $(this).attr('data-uuid');
            $("input[name='uuid_bimbingan']").val($(this).attr('data-uuid'));
            control.overlay_form('Update', 'Penjadwalan', url);
        })
        ...
        $(function() {
            initDatatable();
            control.push_select3(data, '#from_select_metode')
        });
    </script>
@endsection
